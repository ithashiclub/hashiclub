        ...
        <div>
            ...
            <div className="navbar" >
                ...
                <div className="NavContainer" >
                    <Link  to="/hashiclub.github.io/"><img className="Logo" src={Logo} alt="description" /></Link>
                ...
                <div className="rightSide" >
                    ...
                    <div className="menuRigth"  id={openLinks ? "open" : "close"} onClick={closeMenu}>
                        ...
                        <div className="footerMenu"> <a href="https://twitter.com/hashi.club"><TwitterIcon className="iconImage" /> </a>
